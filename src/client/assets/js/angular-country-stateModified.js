(function() {
    ...
    var app = angular.module('angularCountryStateModified', []);

}());
(function() {
    "use strict";
    var template='<div class="form-group">';
    template +='<label class="col-sm-3 control-label" for="country">{{countryLabel}}</label>';
    ...
    template +='<label class="col-sm-3 control-label" for="state">{{stateLabel}}</label>';
    template +='<div class="col-sm-5">';
    template +='<select name="state" ng-model="countryState" required class="form-control">';
    ...
    /*
     ...
     <div class="col-sm-5">
     <country-state-select-modified country="user.country" state="user.state"></country-state-select-modified>
     </div>

     <div class="col-sm-5">
     <input ng-model="userDetail.profession" id="profession" class="form-control" type="text">
     </div>

     <div class="form-group">
     <label class="col-sm-3 control-label" for="profession">Profession</label>
     <div class="col-sm-5">
     <input ng-model="userDetail.profession" id="profession" class="form-control" type="text">
     </div>
     </div>
    */
    ...
    angular
        .module("angularCountryStateModified")
        .directive("countryStateSelectModified", [ function () {
            return {
                restrict: "E",
                template: template,
